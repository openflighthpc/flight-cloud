...
module Cloudware
  class Aws2
    ...
    attr_accessor :pri_subnet_cidr
    attr_accessor :pri_subnet_id
                     ...
                     regions.each do |r|
                       ...
                       vpc_list.vpcs.each do |v|
                         v.tags.each do |t|
                           ...
                           @pri_subnet_cidr = t.value if t.key == 'cloudware_pri_subnet_cidr'
                           @networkid = v.vpc_id
                           @region = r
                         end
                         ...
                         subnet_list.subnets.each do |s|
                           s.tags.each do |t|
                             @pri_subnet_id = s.subnet_id if t.key == "cloudware_#{@domain}_pri_subnet_id"
                           end
                         end
                         ...
                         @domains.merge!(@domain => {
                                           ...
                                           pri_subnet_cidr: @pri_subnet_cidr, pri_subnet_id: @pri_subnet_id,
                      ...
                      regions.each do |r|
                        ...
                        @cfn.describe_stacks.stacks.each do |test|
                          ...
                          test.parameters.each_with_index do |val, _index|
                            ...
                            @priip = val.to_h[:parameter_value] if val.to_h[:parameter_key] == 'priIp'
                          ...
                          @machines.merge!("#{@domain}-#{@name}" => {
                                             ...
                                             id: @id, type: @type, role: @role, pri_ip: @priip, ext_ip: @extip,
                        ...
                        @ec2.describe_instances(filters: [{ name: 'tag-key', values: ['cloudware_id'] }]).reservations.each do |reservation|
                          reservation.instances.each do |instance|
                            ...
                            instance.tags.each do |tag|
                              ...
                              @priip = tag.value if tag.key == 'cloudware_pri_subnet_ip'
    ...
    def create_machine(name, domain, id, priip, role, type, region, flavour)
      ...
      params = [
        ...
        { parameter_key: 'priSubnetId', parameter_value: d.get_item('pri_subnet_id') },
        { parameter_key: 'priSubnetCidr', parameter_value: d.get_item('pri_subnet_cidr') },
